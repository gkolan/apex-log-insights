...
Use this index to choose the documentation bucket that matches your goal. Product screenshots are kept outside this folder under [`assets/images/`](../assets/images/).
...
- [Browser store submissions](../packages/browser-ext/store/README.md)
...
| VS Code candidate evidence      | [VS Code release review](development/vscode-extension-release-review.md) |
