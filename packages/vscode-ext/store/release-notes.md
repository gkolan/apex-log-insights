...
Initial VS Code release candidate:

- local, cancellable parsing in a worker thread;
- canonical Triage Summary, Execution Story, Data & Limits, Diagnostics, and Log Explorer views;
